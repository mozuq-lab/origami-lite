...
/origami:generate-cases --output docs/origami/ecommerce-spec/ --target F-001
```
...
出力先: `{出力先ディレクトリ}/04_テストケース一覧.md` 🔵

- `--output` 指定時: `{--output}/04_テストケース一覧.md`
- 自動決定時: `docs/origami/{仕様書名}/04_テストケース一覧.md`
...
- `{出力先}/04_テストケース一覧.md` が作成されたことを確認
- 以下のサマリーを表示：
